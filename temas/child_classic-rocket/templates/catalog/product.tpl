        ...
        <div class="col-lg-6">
          {block name='page_header_container'}
            {block name='page_header'}
              <h1 class="h1 custom_font_h1">{block name='page_title'}{$product.name}{/block}</h1>
            {/block}
          {/block}
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-accessories mt-3">
          <p class="products-section-title custom_orange">{l s='Otros usuarios vieron' d='Shop.Theme.Catalog'}</p>
          <div class="products">
